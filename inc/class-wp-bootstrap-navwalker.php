	...
	class Understrap_WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			if ( $depth === 0 ) {
				...
				$megamenu = get_field( 'megamenu', $current_menu_item->ID );

				$div_fallback = '<div><div>';

				if ( $megamenu ) {

					$megamenu_content = get_field( 'megamenu_content', $current_menu_item->ID );
					
					if ( $megamenu_content ) {
				
						$output .= '<div class="container megamenu-container">';
							$output .= '<div class="row megamenu-row">';
								$output .= '<div class="col-12 col-lg-4 megamenu-content d-none d-lg-block">';
									$output .= $megamenu_content;
								$output .= '</div>';
								$output .= '<div class="col-12 col-lg-8 megamenu-items">';
