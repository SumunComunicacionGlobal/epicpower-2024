...
if( function_exists('acf_add_local_field_group') ):
    ...
    acf_add_local_field_group(array(
        'key' => 'group_62c2123456789',
        'title' => 'Configuración de elementos del menú',
        'fields' => array(
            array(
                'key' => 'field_62c212345678c',
                'label' => 'Megamenú',
                'name' => 'megamenu',
                'type' => 'true_false',
                'required' => 0,
                ...
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => __( 'Activado', 'smn-admin' ),
                'ui_off_text' => __( 'Desactivado', 'smn-admin' ),
            ),
            array(
                'key' => 'field_62c212345678d',
                'label' => 'Contenido del Megamenú',
                'name' => 'megamenu_content',
                'type' => 'wysiwyg',
                'instructions' => 'Contenido que se muestra en el Megamenú.',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
